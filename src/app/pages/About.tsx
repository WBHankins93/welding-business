    ...
    <div>
      ...
      <section className="relative bg-[#0a0a0a] text-white py-24 md:py-32">
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <h1 className="text-5xl md:text-6xl font-bold mb-6">About DJN Services LLC</h1>
      ...
      <section className="py-20 md:py-28 bg-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl">
            <h2 className="text-4xl md:text-5xl font-bold mb-8 text-[#0a0a0a]">Who we are</h2>
            <div className="space-y-6 text-[#1a1f2e] leading-relaxed text-lg">
              <p>
      ...
      {/* Stats */}
      <section className="bg-[#d4af37] text-[#0a0a0a] py-20 md:py-24">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-10">
            {stats.map((stat) => (
              <div key={stat.label} className="text-center">
                <div className="text-5xl md:text-6xl font-bold mb-3 text-[#0a0a0a]">{stat.number}</div>
                <div className="text-[#1a1f2e] font-semibold text-lg">{stat.label}</div>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-20 md:py-28 bg-[#f7f8fa]">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold mb-6 text-[#0a0a0a]">Our Values</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {values.map((value) => {
              ...
              return (
                <div
                  key={value.title}
                  className="bg-white p-8 rounded-xl shadow-lg text-center hover:shadow-2xl transition-all duration-300 border border-gray-100 hover:border-[#d4af37]/30"
                >
      ...
      <section className="py-20 md:py-28 bg-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-[#f7f8fa] p-10 rounded-xl border border-gray-100 shadow-md">
              <h3 className="text-xl font-bold mb-6 text-[#0a0a0a]">Certifications</h3>
              <ul className="space-y-3 text-[#1a1f2e]">
            ...
            <div className="bg-[#f7f8fa] p-10 rounded-xl border border-gray-100 shadow-md">
              <h3 className="text-xl font-bold mb-6 text-[#0a0a0a]">Specializations</h3>
              <ul className="space-y-3 text-[#1a1f2e]">
                <li className="flex items-center gap-2">
                  <span className="text-[#d4af37] font-bold">•</span>
            ...
            <div className="bg-[#f7f8fa] p-10 rounded-xl border border-gray-100 shadow-md">
              <h3 className="text-xl font-bold mb-6 text-[#0a0a0a]">Equipment</h3>
              <ul className="space-y-3 text-[#1a1f2e]">
                <li className="flex items-center gap-2">
                  <span className="text-[#d4af37] font-bold">•</span>
      ...
      <section className="bg-[#0a0a0a] text-white py-20 md:py-28">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              to="/booking"
              className="bg-[#d4af37] hover:bg-[#fbbf24] text-[#0a0a0a] px-10 py-4 rounded-lg font-semibold transition-all duration-200 shadow-xl hover:shadow-2xl"
            >
              Book Now
            </Link>
            <Link
              to="/contact"
              className="border-2 border-white hover:bg-white hover:text-[#0a0a0a] px-10 py-4 rounded-lg font-semibold transition-all duration-200"
            >
              Get in Touch
            </Link>
          </div>
